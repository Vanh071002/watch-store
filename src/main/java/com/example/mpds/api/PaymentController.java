...
public class PaymentController {
    ...
    @GetMapping()
    public RedirectView createPayment(HttpServletRequest request, @ModelAttribute("invoiceDetail") InvoiceEntity entity, Model model) throws UnsupportedEncodingException, JsonProcessingException {
